...
public class AutoUpdateService extends Service {
    ...
    //实现后台更新天气的功能，创建一个长期在后台运行的定时任务
    //设置时间间隔为8小时，8小时后 AutoUpdateService 的 onStartCommand() 方法就会重新执行
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        PendingIntent pi = PendingIntent.getService(this, 0, i, 0); //指定处理定时任务的服务为 onStartCommend
        manager.cancel(pi);
